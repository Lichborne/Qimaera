...
interface QuantumOpT (0 t : Nat -> Type) where
  ...
  applyUnitaryT : UnitaryOpT r => (n : Nat) -> (i:Nat) -> (1 _ : UStateT (r n) (r n) (LPair (Unitary i) (LVect i Qubit)) ) -> QStateT (t n) (t n) (LPair (Unitary i) (LVect i Qubit))
  ...
  applyCNOT : {n : Nat} -> Qubit -> (1 _ : Qubit) -> QStateT (t n) (t n) (LPair Qubit Qubit)
