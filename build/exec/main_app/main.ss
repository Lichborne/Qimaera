...
(define csegen-64 (vector 3 0 1 (Lemmas-lemma1LTESucc 1) 2 (vector 0 1) (vector 0 )))
(define csegen-65 (lambda (u--out) (lambda (eta-0) (cons eta-0 u--out))))
(define csegen-89 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
(define QStateT-pure (lambda (arg-2 ext-0) (vector 1 (cons ext-0 arg-2))))
(define csegen-94 (lambda (u--q) (lambda (eta-0) (QStateT-pure u--q eta-0))))
(define ControlC-45LinearC-45LIO-u--bindL_LinearBind_IO (lambda (ext-0 ext-1 ext-2) (let ((act-3 (ext-0 ext-2))) ((ext-1 act-3) ext-2))))
(define csegen-98 (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (lambda (eta-4) (ControlC-45LinearC-45LIO-u--bindL_LinearBind_IO eta-2 eta-3 eta-4)))))))
(define csegen-99 (cons (cons 1.0 0.0) '()))
(define csegen-100 (cons csegen-99 '()))
...
(define csegen-119 (vector csegen-38 (lambda (u--b) (lambda (u--a) (lambda (arg-10411) (lambda (arg-10414) (lambda (world-0) (let ((act-1 (arg-10411 world-0))) ((arg-10414 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10425) (lambda (world-0) (let ((act-1 (arg-10425 world-0))) (act-1 world-0)))))))
(define csegen-122 (cons csegen-119 (lambda (u--a) (lambda (arg-13095) arg-13095))))
(define UnitaryNoPrf-HGate (vector 1 0 (vector 0 )))
(define UnitaryNoPrf-S (lambda (arg-1 arg-2) (vector 2 (/ 3.141592653589793 2.0) arg-1 arg-2)))
(define UnitaryNoPrf-SGate (UnitaryNoPrf-S 0 (vector 0 )))
(define UnitaryNoPrf-compose (lambda (arg-1 arg-2) (case (vector-ref arg-1 0) ((0) arg-2) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (vector 1 e-2 (UnitaryNoPrf-compose e-3 arg-2))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (vector 2 e-5 e-6 (UnitaryNoPrf-compose e-7 arg-2)))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (vector 3 e-9 e-10 (UnitaryNoPrf-compose e-11 arg-2)))))))))
(define csegen-127 (UnitaryNoPrf-compose UnitaryNoPrf-HGate UnitaryNoPrf-SGate))
(define Lemmas-ltz1 1)
(define csegen-137 (cons (vector 0 Lemmas-ltz1) '()))
...
(define csegen-159 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Nat u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Nat u--d u--x)))))
...
(define csegen-163 (UnitaryLinear-compose UnitaryLinear-HGate UnitaryLinear-SGate))
(define csegen-177 (cons (cons 0.0 0.0) csegen-99))
(define csegen-178 (cons (cons 0.0 0.0) '()))
(define csegen-179 (cons (cons 1.0 0.0) csegen-178))
(define csegen-182 (cons (cons 0.0 0.0) csegen-178))
(define csegen-187 (cons (/ 1.0 (flsqrt 2.0)) 0.0))
(define csegen-198 (vector 1 0 (Lemmas-lemma1LTESucc 1) (vector 0 )))
(define csegen-232 (vector 1 1 (+ (Lemmas-lemma1LTESucc 1) 1) (vector 0 )))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define UnitaryNoPrf-addSymbol (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-4) '() (cond ((equal? arg-1 0) (cond ((equal? arg-2 0) (let ((e-3 (car arg-3))) (let ((e-4 (cdr arg-3))) (let ((e-7 (car arg-4))) (let ((e-8 (cdr arg-4))) (cons (string-append e-7 e-3) (UnitaryNoPrf-addSymbol 0 1 (cons e-3 e-4) e-8))))))) (else (let ((e-11 (car arg-3))) (let ((e-12 (cdr arg-3))) (let ((e-15 (car arg-4))) (let ((e-16 (cdr arg-4))) (cons (string-append e-15 e-12) (UnitaryNoPrf-addSymbol 0 1 (cons e-11 e-12) e-16)))))))))(else (let ((e-0 (- arg-1 1))) (let ((e-19 (car arg-3))) (let ((e-20 (cdr arg-3))) (let ((e-23 (car arg-4))) (let ((e-24 (cdr arg-4))) (cons (string-append e-23 e-20) (UnitaryNoPrf-addSymbol e-0 0 (cons e-19 e-20) e-24))))))))))))
(define UnitaryNoPrf-addSymbolCNOT (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-4) '() (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (cond ((equal? e-2 0) (cond ((equal? e-3 0) (cond ((equal? arg-2 0) (if (null? arg-4) (cond ((equal? arg-3 0) (if (null? arg-4) (cond (else (cond (else (let ((e-8 (car arg-4))) (let ((e-9 (cdr arg-4))) (cons (string-append e-8 "-----") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) 1 1 e-9)))))))) (let ((e-12 (car arg-4))) (let ((e-13 (cdr arg-4))) (cons (string-append e-12 "- \x398; -") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) arg-2 1 e-13))))))(else (cond (else (cond (else (let ((e-8 (car arg-4))) (let ((e-9 (cdr arg-4))) (cons (string-append e-8 "-----") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) 1 1 e-9)))))))))) (let ((e-16 (car arg-4))) (let ((e-17 (cdr arg-4))) (cons (string-append e-16 "- \x2022; -") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) 1 arg-3 e-17))))))(else (cond ((equal? arg-3 0) (if (null? arg-4) (cond (else (cond (else (let ((e-8 (car arg-4))) (let ((e-9 (cdr arg-4))) (cons (string-append e-8 "-----") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) 1 1 e-9)))))))) (let ((e-12 (car arg-4))) (let ((e-13 (cdr arg-4))) (cons (string-append e-12 "- \x398; -") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) arg-2 1 e-13))))))(else (cond (else (cond (else (let ((e-8 (car arg-4))) (let ((e-9 (cdr arg-4))) (cons (string-append e-8 "-----") (UnitaryNoPrf-addSymbolCNOT (cons 0 0) 1 1 e-9)))))))))))))(else (let ((e-5 (- e-3 1))) (cond ((equal? arg-2 0) (let ((e-20 (car arg-4))) (let ((e-21 (cdr arg-4))) (cons (string-append e-20 "- \x2022; -") (UnitaryNoPrf-addSymbolCNOT (cons 0 e-5) 1 arg-3 e-21))))) (else (let ((e-24 (car arg-4))) (let ((e-25 (cdr arg-4))) (cons (string-append e-24 "--|--") (UnitaryNoPrf-addSymbolCNOT (cons 0 e-5) 1 0 e-25))))))))))(else (let ((e-4 (- e-2 1))) (cond ((equal? e-3 0) (cond ((equal? arg-3 0) (let ((e-29 (car arg-4))) (let ((e-30 (cdr arg-4))) (cons (string-append e-29 "- \x398; -") (UnitaryNoPrf-addSymbolCNOT (cons e-4 0) arg-2 1 e-30))))) (else (let ((e-33 (car arg-4))) (let ((e-34 (cdr arg-4))) (cons (string-append e-33 "--|--") (UnitaryNoPrf-addSymbolCNOT (cons e-4 0) 0 1 e-34)))))))(else (let ((e-26 (- e-3 1))) (let ((e-37 (car arg-4))) (let ((e-38 (cdr arg-4))) (cons (string-append e-37 "-----") (UnitaryNoPrf-addSymbolCNOT (cons e-4 e-26) 0 0 e-38)))))))))))))))
(define UnitaryNoPrf-drawWirePhase (lambda (arg-0) (cond ((equal? arg-0 0) "")(else (let ((e-0 (- arg-0 1))) (string-append "-" (UnitaryNoPrf-drawWirePhase e-0)))))))
...
(define UnitaryNoPrf-newWireQVect (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons "" (UnitaryNoPrf-newWireQVect e-0)))))))
...
(define UnitaryNoPrf-printPhase (lambda (arg-0 arg-1 arg-2) (let ((sc0 (let ((sc1 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- 3.141592653589793 arg-1)))) (cond ((equal? sc1 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ 3.141592653589793 arg-1))) (else 0))))) (cond ((equal? sc0 1) arg-2) (else (let ((sc1 (let ((sc2 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ 3.141592653589793 2.0) arg-1)))) (cond ((equal? sc2 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ 3.141592653589793 2.0) arg-1))) (else 0))))) (cond ((equal? sc1 1) (string-append arg-2 "/2")) (else (let ((sc2 (let ((sc3 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ 3.141592653589793 3.0) arg-1)))) (cond ((equal? sc3 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ 3.141592653589793 3.0) arg-1))) (else 0))))) (cond ((equal? sc2 1) (string-append arg-2 "/3")) (else (let ((sc3 (let ((sc4 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ 3.141592653589793 4.0) arg-1)))) (cond ((equal? sc4 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ 3.141592653589793 4.0) arg-1))) (else 0))))) (cond ((equal? sc3 1) (string-append arg-2 "/4")) (else (let ((sc4 (let ((sc5 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ 3.141592653589793 6.0) arg-1)))) (cond ((equal? sc5 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ 3.141592653589793 6.0) arg-1))) (else 0))))) (cond ((equal? sc4 1) (string-append arg-2 "/6")) (else (let ((sc5 (let ((sc6 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ 3.141592653589793 8.0) arg-1)))) (cond ((equal? sc6 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ 3.141592653589793 8.0) arg-1))) (else 0))))) (cond ((equal? sc5 1) (string-append arg-2 "/8")) (else (let ((sc6 (let ((sc7 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (- 3.141592653589793) arg-1)))) (cond ((equal? sc7 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (- 3.141592653589793) arg-1))) (else 0))))) (cond ((equal? sc6 1) (string-append "-" arg-2)) (else (let ((sc7 (let ((sc8 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ (- 3.141592653589793) 2.0) arg-1)))) (cond ((equal? sc8 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ (- 3.141592653589793) 2.0) arg-1))) (else 0))))) (cond ((equal? sc7 1) (string-append "-" (string-append arg-2 "/2"))) (else (let ((sc8 (let ((sc9 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ (- 3.141592653589793) 3.0) arg-1)))) (cond ((equal? sc9 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ (- 3.141592653589793) 3.0) arg-1))) (else 0))))) (cond ((equal? sc8 1) (string-append "-" (string-append arg-2 "/3"))) (else (let ((sc9 (let ((sc10 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ (- 3.141592653589793) 4.0) arg-1)))) (cond ((equal? sc10 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ (- 3.141592653589793) 4.0) arg-1))) (else 0))))) (cond ((equal? sc9 1) (string-append "-" (string-append arg-2 "/4"))) (else (let ((sc10 (let ((sc11 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ (- 3.141592653589793) 6.0) arg-1)))) (cond ((equal? sc11 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ (- 3.141592653589793) 6.0) arg-1))) (else 0))))) (cond ((equal? sc10 1) (string-append "-" (string-append arg-2 "/6"))) (else (let ((sc11 (let ((sc12 (PreludeC-45EqOrd-u--C-62C-61_Ord_Double arg-0 (- (/ (- 3.141592653589793) 8.0) arg-1)))) (cond ((equal? sc12 1) (PreludeC-45EqOrd-u--C-60C-61_Ord_Double arg-0 (+ (/ (- 3.141592653589793) 8.0) arg-1))) (else 0))))) (cond ((equal? sc11 1) (string-append "-" (string-append arg-2 "/8"))) (else (PreludeC-45Show-u--show_Show_Double arg-0)))))))))))))))))))))))))))))))))))))))
(define UnitaryNoPrf-drawGate (lambda (arg-0 arg-1) (case (vector-ref arg-1 0) ((0) (UnitaryNoPrf-newWireQVect arg-0)) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (UnitaryNoPrf-addSymbol e-2 0 (cons "- H -" "-----") (UnitaryNoPrf-drawGate arg-0 e-3))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (let ((sc1 (let ((sc2 (PreludeC-45EqOrd-u--C-60C-61_Ord_Double (- (/ 3.141592653589793 4.0) 0.001) e-5))) (cond ((equal? sc2 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Double (+ (/ 3.141592653589793 4.0) 0.001) e-5)) (else 0))))) (cond ((equal? sc1 1) (UnitaryNoPrf-addSymbol e-6 0 (cons "- T -" "-----") (UnitaryNoPrf-drawGate arg-0 e-7))) (else (let ((sc2 (let ((sc3 (PreludeC-45EqOrd-u--C-60C-61_Ord_Double (- (/ (- 3.141592653589793) 4.0) 0.001) e-5))) (cond ((equal? sc3 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Double (+ (/ (- 3.141592653589793) 4.0) 0.001) e-5)) (else 0))))) (cond ((equal? sc2 1) (UnitaryNoPrf-addSymbol e-6 0 (cons "- T+ -" "------") (UnitaryNoPrf-drawGate arg-0 e-7))) (else (let ((sc3 (let ((sc4 (PreludeC-45EqOrd-u--C-60C-61_Ord_Double (- (/ 3.141592653589793 2.0) 0.001) e-5))) (cond ((equal? sc4 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Double (+ (/ 3.141592653589793 2.0) 0.001) e-5)) (else 0))))) (cond ((equal? sc3 1) (UnitaryNoPrf-addSymbol e-6 0 (cons "- S -" "-----") (UnitaryNoPrf-drawGate arg-0 e-7))) (else (let ((sc4 (let ((sc5 (PreludeC-45EqOrd-u--C-60C-61_Ord_Double (- (/ (- 3.141592653589793) 2.0) 0.001) e-5))) (cond ((equal? sc5 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Double (+ (/ (- 3.141592653589793) 2.0) 0.001) e-5)) (else 0))))) (cond ((equal? sc4 1) (UnitaryNoPrf-addSymbol e-6 0 (cons "- S+ -" "------") (UnitaryNoPrf-drawGate arg-0 e-7))) (else (let ((sc5 (let ((sc6 (PreludeC-45EqOrd-u--C-60C-61_Ord_Double (- 3.141592653589793 0.001) e-5))) (cond ((equal? sc6 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Double (+ 3.141592653589793 0.001) e-5)) (else 0))))) (cond ((equal? sc5 1) (UnitaryNoPrf-addSymbol e-6 0 (cons "- Z -" "-----") (UnitaryNoPrf-drawGate arg-0 e-7))) (else (let ((u--s (UnitaryNoPrf-printPhase e-5 0.001 "\x3c0;"))) (UnitaryNoPrf-addSymbol e-6 0 (cons (string-append "- P(" (string-append u--s ") -")) (UnitaryNoPrf-drawWirePhase (+ (PreludeC-45TypesC-45String-length u--s) 7))) (UnitaryNoPrf-drawGate arg-0 e-7)))))))))))))))))))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (UnitaryNoPrf-addSymbolCNOT (cons e-9 e-10) 0 0 (UnitaryNoPrf-drawGate arg-0 e-11)))))))))
(define UnitaryNoPrf-drawVect (lambda (arg-1) (if (null? arg-1) "" (let ((e-3 (car arg-1))) (let ((e-4 (cdr arg-1))) (string-append e-3 (string-append "\xa;" (UnitaryNoPrf-drawVect e-4))))))))
(define UnitaryNoPrf-draw (lambda (arg-0 arg-1) (let ((u--vs1 (UnitaryNoPrf-drawGate arg-0 arg-1))) (let ((u--s (UnitaryNoPrf-drawVect u--vs1))) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append u--s "\xa;") eta-0))))))
(define UnitaryNoPrf-UnitaryNoPrftoQiskit (lambda (arg-1) (case (vector-ref arg-1 0) ((0) "") ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (string-append (UnitaryNoPrf-UnitaryNoPrftoQiskit e-3) (string-append "qc.h(qr[" (string-append (PreludeC-45Show-u--show_Show_Nat e-2) "])\xa;qc.barrier(qr)\xa;")))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (string-append (UnitaryNoPrf-UnitaryNoPrftoQiskit e-7) (string-append "qc.p(" (string-append (UnitaryNoPrf-printPhase e-5 0.001 "np.pi") (string-append ", qr[" (string-append (PreludeC-45Show-u--show_Show_Nat e-6) "])\xa;qc.barrier(qr)\xa;"))))))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (string-append (UnitaryNoPrf-UnitaryNoPrftoQiskit e-11) (string-append "qc.cx(qr[" (string-append (PreludeC-45Show-u--show_Show_Nat e-9) (string-append "], qr[" (string-append (PreludeC-45Show-u--show_Show_Nat e-10) "])\xa;qc.barrier(qr)\xa;"))))))))))))
(define UnitaryNoPrf-toQiskit (lambda (arg-0 arg-1) (let ((u--s (UnitaryNoPrf-UnitaryNoPrftoQiskit arg-1))) (string-append "import numpy as np\xa;" (string-append "from qiskit import QuantumCircuit\xa;" (string-append "from qiskit import QuantumRegister\xa;" (string-append "qr = QuantumRegister(" (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) (string-append ")\xa;" (string-append "qc = QuantumCircuit(qr)\xa;\xa;" (string-append u--s "\xa;print(qc)")))))))))))
...
(define UnitaryNoPrf-exportToQiskit (lambda (arg-0 arg-1 arg-2) (let ((u--s (UnitaryNoPrf-toQiskit arg-0 arg-2))) (lambda (world-0) (let ((act-1 ((SystemC-45FileC-45ReadWrite-writeFile csegen-122 arg-1 u--s) world-0))) (case (vector-ref act-1 0) ((0) (PreludeC-45IO-prim__putStr "Error when writing file\xa;" world-0)) (else (vector 0 ))))))))
(define Main-case--caseC-32blockC-32inC-32absControlTestIo-7380 (lambda (arg-0 arg-1 ext-0) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (let ((act-1 ((UnitaryNoPrf-draw 5 e-3) ext-0))) (let ((act-2 ((UnitaryNoPrf-exportToQiskit 5 "absControlTest.py" e-2) ext-0))) e-2))))))
(define UnitaryNoPrfSim-duplicateLinU (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (cons (vector 0 ) (vector 0 ))) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (let ((sc1 (UnitaryNoPrfSim-duplicateLinU e-3))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (cons (vector 1 e-2 e-5) (vector 1 e-2 e-4)))))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (let ((sc1 (UnitaryNoPrfSim-duplicateLinU e-7))) (let ((e-2 (car sc1))) (let ((e-3 (cdr sc1))) (cons (vector 2 e-5 e-6 e-2) (vector 2 e-5 e-6 e-3))))))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (let ((sc1 (UnitaryNoPrfSim-duplicateLinU e-11))) (let ((e-2 (car sc1))) (let ((e-3 (cdr sc1))) (cons (vector 3 e-9 e-10 e-2) (vector 3 e-9 e-10 e-3))))))))))))
(define Main-case--absControlTestIo-7373 (lambda (arg-0 ext-0) (Main-case--caseC-32blockC-32inC-32absControlTestIo-7380 arg-0 (UnitaryNoPrfSim-duplicateLinU arg-0) ext-0)))
...
(define Matrix-ket1 (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons (cons (cons 1.0 0.0) csegen-99) (Matrix-ket1 e-0)))))))
...
(define Matrix-toTensorBasis (lambda (arg-1) (if (null? arg-1) csegen-100 (let ((e-3 (car arg-1))) (let ((e-4 (cdr arg-1))) (let ((e-7 (car e-3))) (let ((e-8 (cdr e-3))) (let ((e-11 (car e-8))) (let ((e-12 (cdr e-8))) (Matrix-tensorProduct (cons (cons e-7 '()) (cons (cons e-11 '()) '())) (Matrix-toTensorBasis e-4)))))))))))
...
(define Matrix-matrixH (cons (cons csegen-187 (cons csegen-187 '())) (cons (cons csegen-187 (cons (cons (/ -1.0 (flsqrt 2.0)) 0.0) '())) '())))
...
(define Matrix-matrixP (lambda (arg-0) (cons csegen-179 (cons (cons (cons 0.0 0.0) (cons (Complex-cis arg-0) '())) '()))))
...
(define Matrix-simpleTensor (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 0) csegen-100)(else (let ((e-0 (- arg-1 1))) (cond ((equal? arg-2 0) (Matrix-tensorProduct arg-0 (Matrix-simpleTensor arg-0 e-0 (+ e-0 1))))(else (let ((e-1 (- arg-2 1))) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-simpleTensor arg-0 e-0 e-1))))))))))
...
(define Matrix-matrixKet0Bra0 (cons csegen-179 (cons csegen-182 '())))
(define Matrix-matrixKet1Bra1 (cons csegen-182 (cons csegen-177 '())))
(define Matrix-matrixX (cons csegen-177 (cons csegen-179 '())))
(define Matrix-tensorCnotAux (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-0 0) csegen-100)(else (let ((e-0 (- arg-0 1))) (cond ((equal? arg-1 0) (cond ((equal? arg-2 0) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-tensorCnotAux e-0 (+ e-0 1) (+ e-0 1))))(else (let ((e-2 (- arg-2 1))) (Matrix-tensorProduct Matrix-matrixKet1Bra1 (Matrix-tensorCnotAux e-0 (+ e-0 1) e-2))))))(else (let ((e-1 (- arg-1 1))) (cond ((equal? arg-2 0) (Matrix-tensorProduct Matrix-matrixX (Matrix-tensorCnotAux e-0 e-1 (+ e-0 1))))(else (let ((e-3 (- arg-2 1))) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-tensorCnotAux e-0 e-1 e-3)))))))))))))
...
(define UnitaryLinear-CNOTGate csegen-64)
...
(define DataC-45Vect-u--toList_Foldable_C-40VectC-32C-36nC-41 (lambda (ext-0) (DataC-45Vect-u--foldr_Foldable_C-40VectC-32C-36nC-41 csegen-89 '() ext-0)))
...
(define UnitaryLinear-controlledH (lambda () (let ((u--h1 (UnitaryLinear-tensor 1 1 (vector 0 ) (UnitaryLinear-compose UnitaryLinear-SAdjGate (UnitaryLinear-compose UnitaryLinear-HGate (UnitaryLinear-compose UnitaryLinear-TGate csegen-163)))))) (let ((u--h2 (UnitaryLinear-tensor 1 1 (vector 0 ) (UnitaryLinear-compose UnitaryLinear-SAdjGate (UnitaryLinear-compose UnitaryLinear-HGate (UnitaryLinear-compose UnitaryLinear-TAdjGate csegen-163)))))) (UnitaryLinear-compose u--h1 (UnitaryLinear-compose UnitaryLinear-CNOTGate u--h2))))))
...
(define QuantumOp-u--applyHQ_QuantumOp_SimulatedOp (lambda (arg-0 arg-1 arg-2 ext-0) (QStateT-C-62C-62C-61 (lambda (eta-0) (QuantumOp-u--applyUST_QuantumOp_SimulatedOp arg-1 1 (let ((e-3 (vector-ref arg-0 2))) ((e-3 arg-1) arg-2)) eta-0)) csegen-94 ext-0)))
...
(define QuantumOp-u--applyPQ_QuantumOp_SimulatedOp (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (QStateT-C-62C-62C-61 (lambda (eta-0) (QuantumOp-u--applyUST_QuantumOp_SimulatedOp arg-1 1 (let ((e-4 (vector-ref arg-0 3))) (((e-4 arg-1) arg-2) arg-3)) eta-0)) csegen-94 ext-0)))
...
(define QuantumOp-reCalculateCounter (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) 0)(else (let ((e-0 (- arg-0 1))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (QuantumOp-smallestMissing (DataC-45VectC-45Sort-sort csegen-113 (+ e-0 1) (cons e-4 e-5))))))))))
...
(define Matrix-ket0 (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons csegen-179 (Matrix-ket0 e-0)))))))
...
(define QuantumOp-runSimulated (lambda (arg-0 arg-1) (ControlC-45LinearC-45LIO-run csegen-38 csegen-98 (vector 4 1 (arg-1 (vector 0 csegen-100 (vector 0 ) '() 0)) (lambda (_-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (let ((e-4 (vector-ref e-2 0))) (cond ((equal? e-4 0) (cond ((equal? arg-0 0) (ControlC-45LinearC-45LIO-u--pure_Applicative_C-40LC-32C-36ioC-41 csegen-38 '()))(else (let ((e-10 (car e-3))) (let ((e-9 (cdr e-3))) (ControlC-45LinearC-45LIO-u--pure_Applicative_C-40LC-32C-36ioC-41 csegen-38 (cons e-10 e-9)))))))(else (blodwen-error-quit "Nat case not covered")))))))))))
...
(define Main-absControlTestU (lambda (arg-1 arg-2) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (let ((e-6 (car e-3))) (let ((e-7 (cdr e-3))) (let ((e-10 (car e-7))) (let ((e-11 (cdr e-7))) (let ((e-14 (car e-11))) (let ((e-15 (cdr e-11))) (lambda (clam-0) (let ((e-18 (car e-15))) (let ((e-19 (cdr e-15))) (UStateT-C-62C-62C-61 (let ((e-21 (vector-ref arg-1 5))) ((((e-21 4) 4) e-2) (let ((e-31 (vector-ref arg-1 5))) ((((e-31 3) 3) e-6) (let ((e-44 (vector-ref arg-1 5))) ((((e-44 2) 2) e-10) (let ((e-62 (vector-ref arg-1 0))) ((((e-62 2) 2) (cons e-14 (cons e-18 '()))) csegen-64)))))))) csegen-65 clam-0))))))))))))))
(define QuantumOp-applyUSTRNoPrfC-39 (lambda (arg-0 arg-1 arg-2 arg-3) (let ((sc0 (arg-2 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((u--unew (UnitaryNoPrf-compose e-2 arg-3))) (cons u--unew e-3)))))))
(define QuantumOp-applyUSTSimulatedRNoPrf (lambda (arg-0 arg-1 arg-2 ext-0) (QuantumOp-applyUSTRNoPrfC-39 arg-0 arg-1 arg-2 ext-0)))
(define UnitaryNoPrf-indexNoPrf (lambda (arg-1 arg-2) (cond ((equal? arg-1 0) (if (null? arg-2) (if (null? arg-2) 0 (cond ((equal? arg-1 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-0 (- arg-1 1))) (let ((e-4 (cdr arg-2))) (UnitaryNoPrf-indexNoPrf e-0 e-4)))))) (let ((e-8 (car arg-2))) e-8)))(else (if (null? arg-2) 0 (cond ((equal? arg-1 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-0 (- arg-1 1))) (let ((e-4 (cdr arg-2))) (UnitaryNoPrf-indexNoPrf e-0 e-4))))))))))
(define UnitaryNoPrf-apply (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (case (vector-ref arg-2 0) ((0) arg-3) ((1) (let ((e-2 (vector-ref arg-2 1))) (let ((e-3 (vector-ref arg-2 2))) (vector 1 (UnitaryNoPrf-indexNoPrf e-2 arg-4) (UnitaryNoPrf-apply arg-0 arg-1 e-3 arg-3 arg-4))))) ((2) (let ((e-5 (vector-ref arg-2 1))) (let ((e-6 (vector-ref arg-2 2))) (let ((e-7 (vector-ref arg-2 3))) (vector 2 e-5 (UnitaryNoPrf-indexNoPrf e-6 arg-4) (UnitaryNoPrf-apply arg-0 arg-1 e-7 arg-3 arg-4)))))) (else (let ((e-9 (vector-ref arg-2 1))) (let ((e-10 (vector-ref arg-2 2))) (let ((e-11 (vector-ref arg-2 3))) (vector 3 (UnitaryNoPrf-indexNoPrf e-9 arg-4) (UnitaryNoPrf-indexNoPrf e-10 arg-4) (UnitaryNoPrf-apply arg-0 arg-1 e-11 arg-3 arg-4)))))))))
(define UnitaryNoPrf-tensor (lambda (arg-0 arg-1 arg-2 arg-3) (UnitaryNoPrf-apply arg-1 (+ arg-0 arg-1) arg-3 (UnitaryNoPrf-apply arg-0 (+ arg-0 arg-1) arg-2 (vector 0 ) (Injection-rangeVect 0 arg-0)) (Injection-rangeVect arg-0 arg-1))))
(define QuantumOp-idUpNoPrf (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-2 0) arg-1)(else (let ((e-0 (- arg-2 1))) (UnitaryNoPrf-tensor arg-0 (+ e-0 1) arg-1 (vector 0 )))))))
...
(define QuantumOp-n--13849-11822-u--newQubitsC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (QuantumOp-newQubitsPointersNoCount arg-2 arg-3 (QuantumOp-mkQubitV 0 arg-2)))) (let ((e-2 (car sc0))) (cons (QuantumOp-idUpNoPrf arg-2 arg-4 arg-3) e-2)))))
(define QuantumOp-newQubitsUSTNoPrf (lambda (arg-0 arg-1 ext-0) (QuantumOp-n--13849-11822-u--newQubitsC-39 arg-0 arg-1 arg-0 arg-1 ext-0)))
(define QuantumOp-case--runUnitaryOpNoPrfC-39-12890 (lambda (arg-0 arg-1 arg-2) (let ((e-2 (car arg-2))) e-2)))
(define QuantumOp-runUnitaryOpNoPrfC-39 (lambda (arg-0 arg-1) (QuantumOp-case--runUnitaryOpNoPrfC-39-12890 arg-0 arg-1 (arg-1 (vector 0 )))))
(define UnitaryNoPrf-adjoint (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (vector 0 )) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (UnitaryNoPrf-compose (UnitaryNoPrf-adjoint e-3) (vector 1 e-2 (vector 0 )))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (UnitaryNoPrf-compose (UnitaryNoPrf-adjoint e-7) (vector 2 (- e-5) e-6 (vector 0 ))))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (UnitaryNoPrf-compose (UnitaryNoPrf-adjoint e-11) (vector 3 e-9 e-10 (vector 0 ))))))))))
(define UnitaryNoPrfSim-case--caseC-32blockC-32inC-32invertNoPrf-5647 (lambda (arg-2 arg-5 arg-6) (let ((e-2 (car arg-6))) (let ((u--invu (UnitaryNoPrf-adjoint e-2))) (let ((sc1 (UnitaryNoPrfSim-duplicateLinU arg-2))) (let ((e-5 (car sc1))) (let ((u--unew (UnitaryNoPrf-compose u--invu e-5))) (cons u--unew arg-5))))))))
(define UnitaryNoPrfSim-invertNoPrf (lambda (arg-2 arg-3) (let ((sc0 (arg-2 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (UnitaryNoPrfSim-case--caseC-32blockC-32inC-32invertNoPrf-5647 arg-3 e-3 (UnitaryNoPrfSim-duplicateLinU e-2)))))))
(define UnitaryNoPrfSim-adjointUSTNoPrfC-39 (lambda (arg-2 ext-0) (UnitaryNoPrfSim-invertNoPrf arg-2 ext-0)))
(define UnitaryNoPrfSim-u--adjointUST_UnitaryOp_UnitaryNoPrf (lambda (ext-1 ext-0) (UnitaryNoPrfSim-adjointUSTNoPrfC-39 ext-1 ext-0)))
(define UnitaryNoPrf-CNOTGate (vector 3 0 1 (vector 0 )))
...
(define UnitaryNoPrfSim-case--applyUnitaryNoPrfC-39-4237 (lambda (arg-0 arg-1 arg-2 arg-3 arg-5) (let ((e-2 (car arg-5))) (let ((e-3 (cdr arg-5))) (let ((sc1 (Injection-decInj arg-0 e-3))) (case (vector-ref sc1 0) ((0) (let ((u--unew (UnitaryNoPrf-apply arg-1 arg-0 arg-3 arg-2 e-3))) (cons u--unew e-2))) (else (let ((u--applicable (QuantumOp-makeNeutralVect arg-1))) (let ((u--un (UnitaryNoPrf-apply arg-1 arg-0 arg-3 arg-2 u--applicable))) (cons u--un e-2))))))))))
(define UnitaryNoPrfSim-applyUnitaryNoPrfC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (UnitaryNoPrfSim-case--applyUnitaryNoPrfC-39-4237 arg-0 arg-1 arg-4 arg-3 (QuantumOp-distributeDupedLVectVect arg-2))))
(define UnitaryNoPrfSim-applyInternal (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (UnitaryNoPrfSim-applyUnitaryNoPrfC-39 arg-0 arg-1 arg-2 arg-3 ext-0)))
(define UnitaryNoPrfSim-applyCNOTSim (lambda (arg-0 arg-1 arg-2 ext-0) (UStateT-C-62C-62C-61 (lambda (eta-0) (UnitaryNoPrfSim-applyInternal arg-0 2 (cons arg-1 (cons arg-2 '())) UnitaryNoPrf-CNOTGate eta-0)) (lambda (_-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (lambda (clam-0) (let ((e-6 (car e-3))) (let ((e-7 (cdr e-3))) (cons clam-0 (cons e-2 (cons e-6 '()))))))))) ext-0)))
(define UnitaryNoPrfSim-u--applyCNOT_UnitaryOp_UnitaryNoPrf (lambda (arg-0 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyCNOTSim arg-0 ext-2 ext-1 ext-0)))
(define UnitaryNoPrf-SAdj (lambda (arg-1 arg-2) (vector 2 (/ (- 3.141592653589793) 2.0) arg-1 arg-2)))
(define UnitaryNoPrf-SAdjGate (UnitaryNoPrf-SAdj 0 (vector 0 )))
(define UnitaryNoPrf-TAdj (lambda (arg-1 arg-2) (vector 2 (/ (- 3.141592653589793) 4.0) arg-1 arg-2)))
(define UnitaryNoPrf-TAdjGate (UnitaryNoPrf-TAdj 0 (vector 0 )))
(define UnitaryNoPrf-T (lambda (arg-1 arg-2) (vector 2 (/ 3.141592653589793 4.0) arg-1 arg-2)))
(define UnitaryNoPrf-TGate (UnitaryNoPrf-T 0 (vector 0 )))
(define UnitaryNoPrf-controlledH (let ((u--h1 (UnitaryNoPrf-tensor 1 1 (vector 0 ) (UnitaryNoPrf-compose UnitaryNoPrf-SAdjGate (UnitaryNoPrf-compose UnitaryNoPrf-HGate (UnitaryNoPrf-compose UnitaryNoPrf-TGate csegen-127)))))) (let ((u--h2 (UnitaryNoPrf-tensor 1 1 (vector 0 ) (UnitaryNoPrf-compose UnitaryNoPrf-SAdjGate (UnitaryNoPrf-compose UnitaryNoPrf-HGate (UnitaryNoPrf-compose UnitaryNoPrf-TAdjGate csegen-127)))))) (UnitaryNoPrf-compose u--h1 (UnitaryNoPrf-compose UnitaryNoPrf-CNOTGate u--h2)))))
(define UnitaryNoPrf-controlledP (lambda (arg-0) (let ((u--p1 (vector 3 0 1 (vector 2 (/ arg-0 2.0) 1 (vector 0 ))))) (vector 3 0 1 (vector 2 (/ (- arg-0) 2.0) 1 u--p1)))))
(define UnitaryNoPrf-toffoli (let ((u--g1 (vector 3 1 2 (vector 1 2 (vector 0 ))))) (let ((u--g2 (vector 3 0 2 (UnitaryNoPrf-TAdj 2 u--g1)))) (let ((u--g3 (vector 3 1 2 (UnitaryNoPrf-T 2 u--g2)))) (let ((u--g4 (vector 3 0 2 (UnitaryNoPrf-TAdj 2 u--g3)))) (let ((u--g5 (vector 3 0 1 (UnitaryNoPrf-T 1 (vector 1 2 (UnitaryNoPrf-T 2 u--g4)))))) (vector 3 0 1 (UnitaryNoPrf-T 0 (UnitaryNoPrf-TAdj 1 u--g5)))))))))
(define UnitaryNoPrf-controlled (lambda (arg-0 arg-1) (case (vector-ref arg-1 0) ((0) (vector 0 )) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (UnitaryNoPrf-apply 2 (+ arg-0 1) UnitaryNoPrf-controlledH (UnitaryNoPrf-controlled arg-0 e-3) (cons 0 (cons (+ e-2 1) '())))))) ((2) (let ((e-5 (vector-ref arg-1 1))) (let ((e-6 (vector-ref arg-1 2))) (let ((e-7 (vector-ref arg-1 3))) (UnitaryNoPrf-apply 2 (+ arg-0 1) (UnitaryNoPrf-controlledP e-5) (UnitaryNoPrf-controlled arg-0 e-7) (cons 0 (cons (+ e-6 1) '()))))))) (else (let ((e-9 (vector-ref arg-1 1))) (let ((e-10 (vector-ref arg-1 2))) (let ((e-11 (vector-ref arg-1 3))) (UnitaryNoPrf-apply 3 (+ arg-0 1) UnitaryNoPrf-toffoli (UnitaryNoPrf-controlled arg-0 e-11) (cons 0 (cons (+ e-9 1) (cons (+ e-10 1) '())))))))))))
...
(define QuantumOp-reCalculateNew (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) 0)(else (let ((e-0 (- arg-0 1))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (QuantumOp-smallestMissing (DataC-45VectC-45Sort-sort csegen-113 (+ e-0 1) (cons e-4 e-5))))))))))
...
(define UnitaryNoPrfSim-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-5041 (lambda (arg-0 arg-1 arg-2 arg-3 arg-6 arg-7 arg-8 arg-11) (let ((e-2 (car arg-11))) (let ((e-3 (cdr arg-11))) (let ((u--v (QuantumOp-newVectOrderN (+ arg-0 arg-1) (+ arg-2 1) e-3))) (let ((u--vn (QuantumOp-findInLin arg-2 arg-7 u--v))) (let ((sc1 (Injection-decInj (+ arg-2 1) (cons arg-7 u--vn)))) (case (vector-ref sc1 0) ((0) (let ((u--unew (UnitaryNoPrf-apply (+ arg-2 1) (+ arg-2 1) (UnitaryNoPrf-controlled arg-2 arg-8) arg-3 (cons arg-7 u--vn)))) (let ((sc2 (QuantumOp-splitLVinto arg-0 arg-1 e-2))) (let ((e-5 (car sc2))) (let ((e-4 (cdr sc2))) (cons u--unew (cons (cons arg-6 e-5) e-4))))))) (else (let ((u--applicableSn (QuantumOp-makeNeutralVect (+ arg-2 1)))) (let ((u--un (UnitaryNoPrf-apply (+ arg-2 1) (+ arg-2 1) (UnitaryNoPrf-controlled arg-2 arg-8) arg-3 u--applicableSn))) (let ((sc2 (QuantumOp-splitLVinto arg-0 arg-1 e-2))) (let ((e-6 (car sc2))) (let ((e-5 (cdr sc2))) (cons u--un (cons (cons arg-6 e-6) e-5))))))))))))))))
(define UnitaryNoPrfSim-applyControlledUSplitSimC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5) (let ((sc0 (QuantumOp-qubitToNatPair arg-3))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((sc1 (arg-4 (vector 0 )))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (let ((e-6 (car e-4))) (let ((e-7 (cdr e-4))) (UnitaryNoPrfSim-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-5041 arg-0 arg-1 arg-2 arg-5 e-2 e-3 e-5 (QuantumOp-distributeDupedLVectVect (LinearTypes-C-43C-43 e-6 e-7)))))))))))))
(define UnitaryNoPrfSim-applyControlledSimulatedSplit (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 ext-0) (UnitaryNoPrfSim-applyControlledUSplitSimC-39 arg-0 arg-1 arg-2 arg-3 arg-4 ext-0)))
(define UnitaryNoPrfSim-u--applyControlWithSplitLVects_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 arg-2 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyControlledSimulatedSplit arg-0 arg-1 arg-2 ext-2 ext-1 ext-0)))
(define UnitaryNoPrfSim-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlSimulatedC-39-4520 (lambda (arg-0 arg-1 arg-2 arg-5 arg-7 arg-8 arg-9) (let ((e-2 (car arg-9))) (let ((e-3 (cdr arg-9))) (let ((u--v (QuantumOp-newVectOrderN arg-0 (+ arg-1 1) e-3))) (let ((u--vn (QuantumOp-findInLin arg-1 arg-8 u--v))) (let ((sc1 (Injection-decInj (+ arg-1 1) (cons arg-8 u--vn)))) (case (vector-ref sc1 0) ((0) (let ((u--unew (UnitaryNoPrf-apply (+ arg-1 1) (+ arg-1 1) (UnitaryNoPrf-controlled arg-1 arg-5) arg-2 (cons arg-8 u--vn)))) (cons u--unew (cons arg-7 e-2)))) (else (let ((u--applicableSn (QuantumOp-makeNeutralVect (+ arg-1 1)))) (let ((u--un (UnitaryNoPrf-apply (+ arg-1 1) (+ arg-1 1) (UnitaryNoPrf-controlled arg-1 arg-5) arg-2 u--applicableSn))) (cons u--un (cons arg-7 e-2)))))))))))))
(define UnitaryNoPrfSim-applyControlSimulatedC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (arg-3 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((sc1 (QuantumOp-qubitToNatPair arg-2))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (UnitaryNoPrfSim-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlSimulatedC-39-4520 arg-1 arg-0 arg-4 e-2 e-5 e-4 (QuantumOp-distributeDupedLVectVect e-3))))))))))
(define UnitaryNoPrfSim-applyControlAbsSimulated (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (UnitaryNoPrfSim-applyControlSimulatedC-39 arg-0 arg-1 arg-2 arg-3 ext-0)))
(define UnitaryNoPrfSim-u--applyControlledAbs_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyControlAbsSimulated arg-0 arg-1 ext-2 ext-1 ext-0)))
(define UnitaryNoPrfSim-applyHSim (lambda (arg-0 arg-1 ext-0) (UStateT-C-62C-62C-61 (lambda (eta-0) (UnitaryNoPrfSim-applyInternal arg-0 1 (cons arg-1 '()) UnitaryNoPrf-HGate eta-0)) (lambda (_-0) (lambda (clam-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (cons clam-0 (cons e-2 '())))))) ext-0)))
(define UnitaryNoPrfSim-u--applyH_UnitaryOp_UnitaryNoPrf (lambda (arg-0 ext-1 ext-0) (UnitaryNoPrfSim-applyHSim arg-0 ext-1 ext-0)))
(define UnitaryNoPrf-PGate (lambda (arg-0) (vector 2 arg-0 0 (vector 0 ))))
(define UnitaryNoPrfSim-applyPSim (lambda (arg-0 arg-1 arg-2 ext-0) (UStateT-C-62C-62C-61 (lambda (eta-0) (UnitaryNoPrfSim-applyInternal arg-0 1 (cons arg-2 '()) (UnitaryNoPrf-PGate arg-1) eta-0)) (lambda (_-0) (lambda (clam-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (cons clam-0 (cons e-2 '())))))) ext-0)))
(define UnitaryNoPrfSim-u--applyP_UnitaryOp_UnitaryNoPrf (lambda (arg-0 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyPSim arg-0 ext-2 ext-1 ext-0)))
(define UnitaryNoPrfSim-applyParallelSimulatedNoPrfC-39 (lambda (arg-1 arg-2 arg-3 arg-4 arg-5) (let ((sc0 (arg-3 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((sc1 (arg-4 (vector 0 )))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (let ((u--umed (UnitaryNoPrf-compose e-2 arg-5))) (let ((u--ufinal (UnitaryNoPrf-compose e-5 u--umed))) (cons u--ufinal (LinearTypes-C-43C-43 e-3 e-4))))))))))))
(define UnitaryNoPrfSim-applyParallelSimulatedNoPrf (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 ext-0) (UnitaryNoPrfSim-applyParallelSimulatedNoPrfC-39 arg-0 arg-1 arg-3 arg-4 ext-0)))
(define UnitaryNoPrfSim-u--applyParallel_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 arg-2 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyParallelSimulatedNoPrf arg-0 arg-1 arg-2 ext-2 ext-1 ext-0)))
(define UnitaryNoPrfSim-applyUnitaryNoPrfOwnC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (QuantumOp-distributeDupedLVectVect arg-2))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (cons (UnitaryNoPrf-apply arg-1 arg-0 arg-3 arg-4 e-3) e-2))))))
(define UnitaryNoPrfSim-applyUnitaryNoPrfOwnSimulated (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (UnitaryNoPrfSim-applyUnitaryNoPrfOwnC-39 arg-0 arg-1 arg-2 arg-3 ext-0)))
(define UnitaryNoPrfSim-u--applyUnitaryOwn_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyUnitaryNoPrfOwnSimulated arg-0 arg-1 ext-2 ext-1 ext-0)))
(define SimulatedOp-toNoPrf (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (vector 0 )) ((1) (let ((e-2 (vector-ref arg-1 1))) (let ((e-4 (vector-ref arg-1 3))) (vector 1 e-2 (SimulatedOp-toNoPrf e-4))))) ((2) (let ((e-6 (vector-ref arg-1 1))) (let ((e-7 (vector-ref arg-1 2))) (let ((e-9 (vector-ref arg-1 4))) (vector 2 e-6 e-7 (SimulatedOp-toNoPrf e-9)))))) (else (let ((e-11 (vector-ref arg-1 1))) (let ((e-12 (vector-ref arg-1 2))) (let ((e-16 (vector-ref arg-1 6))) (vector 3 e-11 e-12 (SimulatedOp-toNoPrf e-16)))))))))
(define UnitaryNoPrfSim-applyUnitaryNoPrfSimulated (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (UnitaryNoPrfSim-applyUnitaryNoPrfC-39 arg-0 arg-1 arg-2 (SimulatedOp-toNoPrf arg-3) ext-0)))
(define UnitaryNoPrfSim-u--applyUnitary_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 ext-2 ext-1 ext-0) (UnitaryNoPrfSim-applyUnitaryNoPrfSimulated arg-0 arg-1 ext-2 ext-1 ext-0)))
(define UnitaryNoPrfSim-exportSelfC-39 (lambda (arg-1 arg-2 arg-3) (let ((sc0 (arg-3 arg-2))) (let ((e-2 (car sc0))) e-2))))
(define UnitaryNoPrfSim-u--exportSelf_UnitaryOp_UnitaryNoPrf (lambda (arg-1 ext-0 ext-1) (UnitaryNoPrfSim-exportSelfC-39 arg-1 ext-0 ext-1)))
(define UnitaryNoPrfSim-reCombineAbsC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (arg-3 arg-4))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((e-6 (car e-3))) (let ((e-7 (cdr e-3))) (cons e-2 (LinearTypes-C-43C-43 e-6 e-7)))))))))
(define UnitaryNoPrfSim-reCombineAbsUnitaryNoPrfSimulated (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (UnitaryNoPrfSim-reCombineAbsC-39 arg-0 arg-1 arg-2 arg-3 ext-0)))
(define UnitaryNoPrfSim-u--reCombineAbs_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 arg-2 ext-1 ext-0) (UnitaryNoPrfSim-reCombineAbsUnitaryNoPrfSimulated arg-2 arg-0 arg-1 ext-1 ext-0)))
(define UnitaryNoPrfSim-u--reCombine_UnitaryOp_UnitaryNoPrf (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 ext-0) (cons ext-0 (LinearTypes-C-43C-43 arg-3 arg-4))))
(define UnitaryNoPrfSim-u--run_UnitaryOp_UnitaryNoPrf (lambda (arg-1 ext-0 ext-1) (ext-1 ext-0)))
(define Main-absControlTest (lambda () (QuantumOp-runUnitaryOpNoPrfC-39 5 (lambda (eta-0) (UStateT-C-62C-62C-61 (lambda (eta-1) (QuantumOp-newQubitsUSTNoPrf 0 5 eta-1)) (lambda (u--cs) (lambda (eta-1) (UStateT-C-62C-62C-61 (lambda (eta-2) (QuantumOp-applyUSTSimulatedRNoPrf 5 5 (Main-absControlTestU (vector (lambda (u--n) (lambda (u--i) (lambda (arg-4156) (lambda (arg-4159) (lambda (eta-3) (UnitaryNoPrfSim-u--applyUnitary_UnitaryOp_UnitaryNoPrf u--n u--i arg-4156 arg-4159 eta-3)))))) (lambda (u--n) (lambda (u--i) (lambda (arg-4172) (lambda (u--ownUnitary) (lambda (eta-3) (UnitaryNoPrfSim-u--applyUnitaryOwn_UnitaryOp_UnitaryNoPrf u--n u--i arg-4172 u--ownUnitary eta-3)))))) (lambda (u--n) (lambda (arg-4185) (lambda (eta-3) (UnitaryNoPrfSim-u--applyH_UnitaryOp_UnitaryNoPrf u--n arg-4185 eta-3)))) (lambda (u--n) (lambda (arg-4197) (lambda (arg-4200) (lambda (eta-3) (UnitaryNoPrfSim-u--applyP_UnitaryOp_UnitaryNoPrf u--n arg-4197 arg-4200 eta-3))))) (lambda (u--n) (lambda (arg-4213) (lambda (arg-4216) (lambda (eta-3) (UnitaryNoPrfSim-u--applyCNOT_UnitaryOp_UnitaryNoPrf u--n arg-4213 arg-4216 eta-3))))) (lambda (u--n) (lambda (u--i) (lambda (arg-4231) (lambda (arg-4234) (lambda (eta-3) (UnitaryNoPrfSim-u--applyControlledAbs_UnitaryOp_UnitaryNoPrf u--n u--i arg-4231 arg-4234 eta-3)))))) (lambda (u--n) (lambda (u--i) (lambda (u--j) (lambda (arg-4252) (lambda (arg-4255) (lambda (eta-3) (UnitaryNoPrfSim-u--applyParallel_UnitaryOp_UnitaryNoPrf u--n u--i u--j arg-4252 arg-4255 eta-3))))))) (lambda (u--i) (lambda (u--n) (lambda (arg-4267) (lambda (eta-3) (UnitaryNoPrfSim-u--adjointUST_UnitaryOp_UnitaryNoPrf arg-4267 eta-3))))) (lambda (u--n) (lambda (u--i) (lambda (arg-4275) (lambda (arg-4278) (UnitaryNoPrfSim-u--run_UnitaryOp_UnitaryNoPrf u--i arg-4275 arg-4278))))) (lambda (u--n) (lambda (u--i) (lambda (arg-4288) (lambda (arg-4291) (UnitaryNoPrfSim-u--exportSelf_UnitaryOp_UnitaryNoPrf u--i arg-4288 arg-4291))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-4305) (lambda (arg-4308) (lambda (eta-3) (UnitaryNoPrfSim-u--reCombine_UnitaryOp_UnitaryNoPrf u--i u--j u--n arg-4305 arg-4308 eta-3))))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-4326) (lambda (eta-3) (UnitaryNoPrfSim-u--reCombineAbs_UnitaryOp_UnitaryNoPrf u--i u--j u--n arg-4326 eta-3)))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-4343) (lambda (arg-4346) (lambda (eta-3) (UnitaryNoPrfSim-u--applyControlWithSplitLVects_UnitaryOp_UnitaryNoPrf u--i u--j u--n arg-4343 arg-4346 eta-3)))))))) u--cs) eta-2)) csegen-65 eta-1))) eta-0)))))
(define Main-absControlTestIo (lambda () (lambda (eta-0) (Main-case--absControlTestIo-7373 (Main-absControlTest) eta-0))))
(define Examples-toBellBasis (vector 3 0 1 (Lemmas-lemma1LTESucc 1) 2 (vector 0 1) csegen-198))
...
(define Examples-depthExample2 (vector 1 2 3 (vector 1 1 (+ (Lemmas-lemma1LTESucc 1) 1) (vector 1 0 (Lemmas-lemma1LTESucc 2) csegen-232))))
...
(define Examples-parametrized_example2 (lambda (arg-0 arg-1 arg-2) (UnitaryLinear-compose UnitaryLinear-CNOTGate (UnitaryLinear-compose (cond ((equal? arg-0 1) csegen-198) (else (vector 0 ))) (cond ((equal? arg-1 1) (vector 0 )) (else (vector 2 arg-2 1 2 (vector 0 ))))))))
