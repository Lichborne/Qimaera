...
(define csegen-95 (lambda (u--q) (lambda (eta-0) (QStateT-pure u--q eta-0))))
(define ControlC-45LinearC-45LIO-u--bindL_LinearBind_IO (lambda (ext-0 ext-1 ext-2) (let ((act-3 (ext-0 ext-2))) ((ext-1 act-3) ext-2))))
(define csegen-99 (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (lambda (eta-4) (ControlC-45LinearC-45LIO-u--bindL_LinearBind_IO eta-2 eta-3 eta-4)))))))
(define csegen-100 (cons (cons 1.0 0.0) '()))
(define csegen-101 (cons csegen-100 '()))
...
(define csegen-120 (vector csegen-42 (lambda (u--b) (lambda (u--a) (lambda (arg-10411) (lambda (arg-10414) (lambda (world-0) (let ((act-1 (arg-10411 world-0))) ((arg-10414 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10425) (lambda (world-0) (let ((act-1 (arg-10425 world-0))) (act-1 world-0)))))))
(define csegen-123 (cons csegen-120 (lambda (u--a) (lambda (arg-13095) arg-13095))))
(define csegen-126 (lambda (eta-0) (lambda (eta-1) (cons eta-0 eta-1))))
...
(define csegen-131 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Nat u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Nat u--d u--x)))))
...
(define csegen-135 (UnitaryLinear-compose UnitaryLinear-HGate UnitaryLinear-SGate))
(define Lemmas-ltz1 1)
(define csegen-155 (cons (vector 0 Lemmas-ltz1) '()))
(define csegen-171 (cons (cons 0.0 0.0) csegen-100))
(define csegen-172 (cons (cons 0.0 0.0) '()))
(define csegen-173 (cons (cons 1.0 0.0) csegen-172))
(define csegen-176 (cons (cons 0.0 0.0) csegen-172))
(define csegen-181 (cons (/ 1.0 (flsqrt 2.0)) 0.0))
(define Lemmas-lemma1LTESucc (lambda (arg-0) (cond ((equal? arg-0 0) 1)(else (let ((e-0 (- arg-0 1))) (Lemmas-lemma1LTESucc e-0))))))
(define csegen-194 (vector 1 0 (Lemmas-lemma1LTESucc 1) (vector 0 )))
(define csegen-228 (vector 1 1 (+ (Lemmas-lemma1LTESucc 1) 1) (vector 0 )))
...
(define Matrix-ket1 (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons (cons (cons 1.0 0.0) csegen-100) (Matrix-ket1 e-0)))))))
...
(define Matrix-toTensorBasis (lambda (arg-1) (if (null? arg-1) csegen-101 (let ((e-3 (car arg-1))) (let ((e-4 (cdr arg-1))) (let ((e-7 (car e-3))) (let ((e-8 (cdr e-3))) (let ((e-11 (car e-8))) (let ((e-12 (cdr e-8))) (Matrix-tensorProduct (cons (cons e-7 '()) (cons (cons e-11 '()) '())) (Matrix-toTensorBasis e-4)))))))))))
...
(define Matrix-matrixH (cons (cons csegen-181 (cons csegen-181 '())) (cons (cons csegen-181 (cons (cons (/ -1.0 (flsqrt 2.0)) 0.0) '())) '())))
...
(define Matrix-matrixP (lambda (arg-0) (cons csegen-173 (cons (cons (cons 0.0 0.0) (cons (Complex-cis arg-0) '())) '()))))
...
(define Matrix-simpleTensor (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 0) csegen-101)(else (let ((e-0 (- arg-1 1))) (cond ((equal? arg-2 0) (Matrix-tensorProduct arg-0 (Matrix-simpleTensor arg-0 e-0 (+ e-0 1))))(else (let ((e-1 (- arg-2 1))) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-simpleTensor arg-0 e-0 e-1))))))))))
...
(define Matrix-matrixKet0Bra0 (cons csegen-173 (cons csegen-176 '())))
(define Matrix-matrixKet1Bra1 (cons csegen-176 (cons csegen-171 '())))
(define Matrix-matrixX (cons csegen-171 (cons csegen-173 '())))
(define Matrix-tensorCnotAux (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-0 0) csegen-101)(else (let ((e-0 (- arg-0 1))) (cond ((equal? arg-1 0) (cond ((equal? arg-2 0) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-tensorCnotAux e-0 (+ e-0 1) (+ e-0 1))))(else (let ((e-2 (- arg-2 1))) (Matrix-tensorProduct Matrix-matrixKet1Bra1 (Matrix-tensorCnotAux e-0 (+ e-0 1) e-2))))))(else (let ((e-1 (- arg-1 1))) (cond ((equal? arg-2 0) (Matrix-tensorProduct Matrix-matrixX (Matrix-tensorCnotAux e-0 e-1 (+ e-0 1))))(else (let ((e-3 (- arg-2 1))) (Matrix-tensorProduct (Matrix-matrixId 2) (Matrix-tensorCnotAux e-0 e-1 e-3)))))))))))))
...
(define DataC-45Vect-u--toList_Foldable_C-40VectC-32C-36nC-41 (lambda (ext-0) (DataC-45Vect-u--foldr_Foldable_C-40VectC-32C-36nC-41 csegen-126 '() ext-0)))
...
(define UnitaryLinear-controlledH (lambda () (let ((u--h1 (UnitaryLinear-tensor 1 1 (vector 0 ) (UnitaryLinear-compose UnitaryLinear-SAdjGate (UnitaryLinear-compose UnitaryLinear-HGate (UnitaryLinear-compose UnitaryLinear-TGate csegen-135)))))) (let ((u--h2 (UnitaryLinear-tensor 1 1 (vector 0 ) (UnitaryLinear-compose UnitaryLinear-SAdjGate (UnitaryLinear-compose UnitaryLinear-HGate (UnitaryLinear-compose UnitaryLinear-TAdjGate csegen-135)))))) (UnitaryLinear-compose u--h1 (UnitaryLinear-compose UnitaryLinear-CNOTGate u--h2))))))
...
(define QuantumOp-u--applyHQ_QuantumOp_SimulatedOp (lambda (arg-0 arg-1 arg-2 ext-0) (QStateT-C-62C-62C-61 (lambda (eta-0) (QuantumOp-u--applyUST_QuantumOp_SimulatedOp arg-1 1 (let ((e-4 (vector-ref arg-0 3))) ((e-4 arg-1) arg-2)) eta-0)) csegen-95 ext-0)))
...
(define QuantumOp-u--applyPQ_QuantumOp_SimulatedOp (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (QStateT-C-62C-62C-61 (lambda (eta-0) (QuantumOp-u--applyUST_QuantumOp_SimulatedOp arg-1 1 (let ((e-5 (vector-ref arg-0 4))) (((e-5 arg-1) arg-2) arg-3)) eta-0)) csegen-95 ext-0)))
...
(define QuantumOp-reCalculateCounter (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) 0)(else (let ((e-0 (- arg-0 1))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (QuantumOp-smallestMissing (DataC-45VectC-45Sort-sort csegen-114 (+ e-0 1) (cons e-4 e-5))))))))))
...
(define Matrix-ket0 (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons csegen-173 (Matrix-ket0 e-0)))))))
...
(define UnitaryLinear-exportToQiskit (lambda (arg-0 arg-1 arg-2) (let ((u--s (UnitaryLinear-toQiskit arg-0 arg-2))) (lambda (world-0) (let ((act-1 ((SystemC-45FileC-45ReadWrite-writeFile csegen-123 arg-1 u--s) world-0))) (case (vector-ref act-1 0) ((0) (PreludeC-45IO-prim__putStr "Error when writing file\xa;" world-0)) (else (vector 0 ))))))))
...
(define UnitarySimulated-case--caseC-32blockC-32inC-32invert-21021 (lambda (arg-2 arg-5 arg-6) (let ((e-2 (car arg-6))) (let ((u--invu (UnitaryLinear-adjoint e-2))) (let ((sc1 (UnitarySimulated-duplicateLinU arg-2))) (let ((e-5 (car sc1))) (let ((u--unew (UnitaryLinear-compose u--invu e-5))) (cons u--unew arg-5))))))))
(define UnitarySimulated-invert (lambda (arg-2 arg-3) (let ((sc0 (arg-2 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (UnitarySimulated-case--caseC-32blockC-32inC-32invert-21021 arg-3 e-3 (UnitarySimulated-duplicateLinU e-2)))))))
...
(define UnitarySimulated-case--applyUnitaryC-39-20474 (lambda (arg-0 arg-1 arg-2 arg-3 arg-5) (let ((e-2 (car arg-5))) (let ((e-3 (cdr arg-5))) (let ((sc1 (Injection-decInj arg-0 e-3))) (case (vector-ref sc1 0) ((0) (let ((e-1 (vector-ref sc1 1))) (let ((u--unew (UnitaryLinear-apply arg-2 arg-0 arg-3 arg-1 e-3 e-1))) (cons u--unew e-2)))) (else (let ((u--applicable (QuantumOp-makeNeutralVect arg-2))) (let ((sc2 (UnitaryLinear-applyOrErrorIO arg-2 arg-0 arg-3 arg-1 u--applicable))) (let ((e-6 (car sc2))) (cons e-6 e-2)))))))))))
(define UnitarySimulated-applyUnitaryC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (UnitarySimulated-case--applyUnitaryC-39-20474 arg-0 arg-4 arg-1 arg-3 (QuantumOp-distributeDupedLVectVect arg-2))))
...
(define UnitarySimulated-reCalculateNew (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) 0)(else (let ((e-0 (- arg-0 1))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (QuantumOp-smallestMissing (DataC-45VectC-45Sort-sort csegen-114 (+ e-0 1) (cons e-4 e-5))))))))))
...
(define UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-19939 (lambda (arg-0 arg-1 arg-2 arg-3 arg-6 arg-7 arg-8 arg-11 arg-12 arg-13 arg-14 arg-15) (case (vector-ref arg-15 0) ((0) (let ((e-1 (vector-ref arg-15 1))) (let ((u--unew (UnitaryLinear-apply (+ arg-2 1) (+ arg-2 1) (UnitaryLinear-controlled arg-2 arg-8) arg-3 (cons arg-7 arg-14) e-1))) (let ((sc1 (QuantumOp-splitLVinto arg-0 arg-1 arg-11))) (let ((e-2 (car sc1))) (let ((e-3 (cdr sc1))) (cons u--unew (cons (cons arg-6 e-2) e-3)))))))) (else (let ((u--applicableSn (QuantumOp-makeNeutralVect (+ arg-2 1)))) (let ((sc1 (UnitaryLinear-applyOrErrorIO (+ arg-2 1) (+ arg-2 1) (UnitaryLinear-controlled arg-2 arg-8) arg-3 u--applicableSn))) (let ((e-2 (car sc1))) (let ((sc2 (QuantumOp-splitLVinto arg-0 arg-1 arg-11))) (let ((e-6 (car sc2))) (let ((e-5 (cdr sc2))) (cons e-2 (cons (cons arg-6 e-6) e-5))))))))))))
(define UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-19893 (lambda (arg-0 arg-1 arg-2 arg-3 arg-6 arg-7 arg-8 arg-11) (let ((e-2 (car arg-11))) (let ((e-3 (cdr arg-11))) (let ((u--v (UnitarySimulated-newVectOrderN (+ arg-0 arg-1) (+ arg-2 1) e-3))) (let ((u--vn (UnitarySimulated-findInLin arg-2 arg-7 u--v))) (UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-19939 arg-0 arg-1 arg-2 arg-3 arg-6 arg-7 arg-8 e-2 e-3 u--v u--vn (Injection-decInj (+ arg-2 1) (cons arg-7 u--vn)))))))))
(define UnitarySimulated-applyControlledUSplitSimC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5) (let ((sc0 (QuantumOp-qubitToNatPair arg-3))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((sc1 (arg-4 (vector 0 )))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (let ((e-6 (car e-4))) (let ((e-7 (cdr e-4))) (UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlledUSplitSimC-39-19893 arg-0 arg-1 arg-2 arg-5 e-2 e-3 e-5 (QuantumOp-distributeDupedLVectVect (LinearTypes-C-43C-43 e-6 e-7)))))))))))))
...
(define UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlSimulatedC-39-19322 (lambda (arg-0 arg-1 arg-2 arg-5 arg-6 arg-7 arg-9) (let ((e-2 (car arg-9))) (let ((e-3 (cdr arg-9))) (let ((u--v (UnitarySimulated-newVectOrderN arg-2 (+ arg-0 1) e-3))) (let ((u--vn (UnitarySimulated-findInLin arg-0 arg-6 u--v))) (let ((sc1 (Injection-decInj (+ arg-0 1) (cons arg-6 u--vn)))) (case (vector-ref sc1 0) ((0) (let ((e-1 (vector-ref sc1 1))) (let ((u--unew (UnitaryLinear-apply (+ arg-0 1) (+ arg-0 1) (UnitaryLinear-controlled arg-0 arg-7) arg-1 (cons arg-6 u--vn) e-1))) (cons u--unew (cons arg-5 e-2))))) (else (let ((u--applicableSn (QuantumOp-makeNeutralVect (+ arg-0 1)))) (let ((sc2 (UnitaryLinear-applyOrErrorIO (+ arg-0 1) (+ arg-0 1) (UnitaryLinear-controlled arg-0 arg-7) arg-1 u--applicableSn))) (let ((e-6 (car sc2))) (cons e-6 (cons arg-5 e-2))))))))))))))
(define UnitarySimulated-applyControlSimulatedC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (QuantumOp-qubitToNatPair arg-2))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((sc1 (arg-3 (vector 0 )))) (let ((e-5 (car sc1))) (let ((e-4 (cdr sc1))) (UnitarySimulated-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32applyControlSimulatedC-39-19322 arg-0 arg-4 arg-1 e-2 e-3 e-5 (QuantumOp-distributeDupedLVectVect e-4))))))))))
...
(define UnitarySimulated-applyUnitaryAbsC-39 (lambda (arg-0 arg-1 arg-2 arg-3) (let ((sc0 (arg-2 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((u--ufinal (UnitaryLinear-compose e-2 arg-3))) (cons u--ufinal e-3)))))))
...
(define UnitarySimulated-case--applyUnitaryOwnC-39-20635 (lambda (arg-0 arg-1 arg-2 arg-3 arg-5) (let ((e-2 (car arg-5))) (let ((e-3 (cdr arg-5))) (let ((sc1 (Injection-decInj arg-0 e-3))) (case (vector-ref sc1 0) ((0) (let ((e-1 (vector-ref sc1 1))) (let ((u--unew (UnitaryLinear-apply arg-1 arg-0 arg-3 arg-2 e-3 e-1))) (cons u--unew e-2)))) (else (let ((u--applicable (QuantumOp-makeNeutralVect arg-1))) (let ((sc2 (UnitaryLinear-applyOrErrorIO arg-1 arg-0 arg-3 arg-2 u--applicable))) (let ((e-6 (car sc2))) (cons e-6 e-2)))))))))))
(define UnitarySimulated-applyUnitaryOwnC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (UnitarySimulated-case--applyUnitaryOwnC-39-20635 arg-0 arg-1 arg-4 arg-3 (QuantumOp-distributeDupedLVectVect arg-2))))
...
(define UnitarySimulated-applyWithSplitLVectsC-39 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4) (let ((sc0 (arg-3 (vector 0 )))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (let ((u--unew (UnitaryLinear-compose e-2 arg-4))) (cons u--unew e-3)))))))
...
(define Main-qftControlTest (lambda () (QuantumOp-runUnitaryOpC-39 4 (lambda (eta-0) (UStateT-C-62C-62C-61 (lambda (eta-1) (QuantumOp-newQubitsUST 0 1 eta-1)) (lambda (_-0) (lambda (clam-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (UStateT-C-62C-62C-61 (lambda (eta-1) (QuantumOp-newQubitsUST 1 3 eta-1)) (lambda (_-1) (let ((e-5 (car _-1))) (let ((e-4 (cdr _-1))) (let ((e-6 (car e-4))) (let ((e-7 (cdr e-4))) (lambda (clam-1) (let ((e-10 (car e-7))) (let ((e-11 (cdr e-7))) (UStateT-C-62C-62C-61 (lambda (eta-1) (QuantumOp-applyUSTSimulatedR 4 4 (lambda (eta-2) (UnitarySimulated-u--applyUnitaryAbs_UnitaryOp_Unitary 4 4 (lambda (eta-3) (UnitarySimulated-u--applyControlledAbs_UnitaryOp_Unitary 3 3 e-5 (QFT-qftUAbs (vector (lambda (u--n) (lambda (u--i) (lambda (arg-9803) (lambda (arg-9806) (lambda (eta-4) (UnitarySimulated-u--applyUnitary_UnitaryOp_Unitary u--n u--i arg-9803 arg-9806 eta-4)))))) (lambda (u--n) (lambda (u--i) (lambda (arg-9819) (lambda (u--ownUnitary) (lambda (eta-4) (UnitarySimulated-u--applyUnitaryOwn_UnitaryOp_Unitary u--n u--i arg-9819 u--ownUnitary eta-4)))))) (lambda (u--n) (lambda (u--i) (lambda (arg-9834) (lambda (eta-4) (UnitarySimulated-u--applyUnitaryAbs_UnitaryOp_Unitary u--n u--i arg-9834 eta-4))))) (lambda (u--n) (lambda (arg-9844) (lambda (eta-4) (UnitarySimulated-u--applyH_UnitaryOp_Unitary u--n arg-9844 eta-4)))) (lambda (u--n) (lambda (arg-9856) (lambda (arg-9859) (lambda (eta-4) (UnitarySimulated-u--applyP_UnitaryOp_Unitary u--n arg-9856 arg-9859 eta-4))))) (lambda (u--n) (lambda (arg-9872) (lambda (arg-9875) (lambda (eta-4) (UnitarySimulated-u--applyCNOT_UnitaryOp_Unitary u--n arg-9872 arg-9875 eta-4))))) (lambda (u--n) (lambda (u--i) (lambda (arg-9890) (lambda (arg-9893) (lambda (eta-4) (UnitarySimulated-u--applyControlledAbs_UnitaryOp_Unitary u--n u--i arg-9890 arg-9893 eta-4)))))) (lambda (u--n) (lambda (u--i) (lambda (u--j) (lambda (arg-9911) (lambda (arg-9914) (lambda (eta-4) (UnitarySimulated-u--applyParallel_UnitaryOp_Unitary u--n u--i u--j arg-9911 arg-9914 eta-4))))))) (lambda (u--i) (lambda (u--n) (lambda (arg-9926) (lambda (eta-4) (UnitarySimulated-u--adjointUST_UnitaryOp_Unitary arg-9926 eta-4))))) (lambda (u--n) (lambda (u--i) (lambda (arg-9934) (lambda (arg-9937) (UnitarySimulated-u--run_UnitaryOp_Unitary u--i arg-9934 arg-9937))))) (lambda (u--n) (lambda (u--i) (lambda (arg-9947) (lambda (arg-9950) (UnitarySimulated-u--exportSelf_UnitaryOp_Unitary u--i arg-9947 arg-9950))))) (lambda (u--n) (lambda (u--i) (lambda (u--j) (lambda (arg-9962) (lambda (arg-9965) (UnitarySimulated-u--runSplit_UnitaryOp_Unitary u--i u--j arg-9962 arg-9965)))))) (lambda (u--n) (lambda (u--i) (lambda (u--j) (lambda (arg-9980) (lambda (eta-4) (UnitarySimulated-u--applyWithSplitLVects_UnitaryOp_Unitary u--n u--i u--j arg-9980 eta-4)))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-9995) (lambda (arg-9998) (lambda (eta-4) (UnitarySimulated-u--reCombine_UnitaryOp_Unitary u--i u--j u--n arg-9995 arg-9998 eta-4))))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-10016) (lambda (eta-4) (UnitarySimulated-u--reCombineAbs_UnitaryOp_Unitary u--i u--j u--n arg-10016 eta-4)))))) (lambda (u--i) (lambda (u--j) (lambda (u--n) (lambda (arg-10033) (lambda (arg-10036) (lambda (eta-4) (UnitarySimulated-u--applyControlWithSplitLVects_UnitaryOp_Unitary u--i u--j u--n arg-10033 arg-10036 eta-4)))))))) 3 3 (cons e-2 (cons e-6 (cons e-10 '())))) eta-3)) eta-2)) eta-1)) (lambda (u--out) (lambda (eta-1) (cons eta-1 u--out))) clam-1))))))))) clam-0))))) eta-0)))))
...
(define Examples-toBellBasis (vector 3 0 1 (Lemmas-lemma1LTESucc 1) 2 (vector 0 1) csegen-194))
...
(define Examples-depthExample2 (vector 1 2 3 (vector 1 1 (+ (Lemmas-lemma1LTESucc 1) 1) (vector 1 0 (Lemmas-lemma1LTESucc 2) csegen-228))))
...
(define Examples-parametrized_example2 (lambda (arg-0 arg-1 arg-2) (UnitaryLinear-compose UnitaryLinear-CNOTGate (UnitaryLinear-compose (cond ((equal? arg-0 1) csegen-194) (else (vector 0 ))) (cond ((equal? arg-1 1) (vector 0 )) (else (vector 2 arg-2 1 2 (vector 0 ))))))))
