...
(define UnitaryLinear-exportForQVis (lambda (arg-0 arg-1 arg-2) (let ((u--s (UnitaryLinear-toQVis arg-0 arg-2))) (lambda (world-0) (let ((act-1 ((SystemC-45FileC-45ReadWrite-writeFile csegen-125 arg-1 u--s) world-0))) (case (vector-ref act-1 0) ((0) (PreludeC-45IO-prim__putStr "Error when writing file\xa;" world-0)) (else (vector 0 ))))))))
